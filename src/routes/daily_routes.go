...
func ActivityRoutes(e *echo.Echo) {
	...
	g.PATCH("/chat/:chatId", controllers.UpdateChat, middleware.VerifyToken, middleware.AuthorizeRole(4))
	g.PATCH("/:id/chat/read", controllers.ReadChat, middleware.VerifyToken, middleware.AuthorizeRole(4))
	g.PATCH("/chat/read-all", controllers.ReadAllChat, middleware.VerifyToken, middleware.AuthorizeRole(4))
